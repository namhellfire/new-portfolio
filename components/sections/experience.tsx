    ...
    <section id="experience" className="relative px-6 py-32">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative">
          {/* Timeline line */}
          <motion.div
            className="absolute left-8 top-0 hidden h-full w-px bg-gradient-to-b from-violet-500/50 via-purple-500/30 to-transparent md:block"
            initial={{ height: 0 }}
            ...
            {experiences.map((exp, index) => (
              ...
              >
                <div className="relative md:pl-20">
                  {/* Timeline dot */}
                  <motion.div
                    className="absolute left-6 top-8 hidden h-4 w-4 rounded-full border-2 border-violet-500 bg-slate-900 md:block"
                    initial={{ scale: 0 }}
                    whileInView={{ scale: 1 }}
                    viewport={{ once: true }}
                  ...
                  <GlassCard glow glowColor="violet" className="group">
                    ...
                    <ul className="mb-6 space-y-3">
                      {exp.description.map((item, i) => (
                        ...
                        >
                          <ChevronRight className="mt-1 h-4 w-4 shrink-0 text-violet-400" />
                          <span>{item}</span>
                        </motion.li>
                      ))}
                    </ul>
